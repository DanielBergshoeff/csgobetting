...
def probableMapBan (results): # [team1ratio, aantal spellen team 1, team2ratio, aant spel 2, map]
    ...
    if (results[0][3] > 1 and results[0][2] > 0.55):
        return results[0][4]
    elif (results[1][0] < 0.5 and results[1][3] > 1 and results[1][2] > 0.55):
        return results[1][4]
...
def probableMapPick (inputresults):
    ...
    if (results[0][0] > results[0][2] and results[0][1] > 3):
        return results[0][4]
    elif (results[1][0] > results[1][2] and results[1][1] > 3):
        return results[1][4]
